(define (domain belkan-domain)	  
 ...
 ;Lista de predicados
  ...
  (:functions
  	(capacidad-mochila)
  	(cantidadObjetosMochila)
  	(puntuacionObjeto ?p - personaje ?o - objeto)
    (puntuacion-total)
  )
  ...
  (:action meterObjetoEnMochila
	     ...
	     (
	        and
	        (< (cantidadObjetosMochila) (capacidad-mochila))
	        (hasThingJugador ?j ?o)
	     )
	     :effect 
	     (
	        ...
	        (not(hasThingJugador ?j ?o))
	        (objetoEnMochila ?o)
	        (increase (cantidadObjetosMochila) 1)
	     )
  )
  ...
  (:action sacarObjetoDeMochila
	     ...
	     (
	        and
	         ...
	         (not(puedeCogerObjeto))
	         (hasThingJugador ?j ?o)
	         (decrease (cantidadObjetosMochila) 1)        
	     )
  )
  ...
  (:action giveObject
	     ...
	     (
	        ...
	        (increase (puntuacion-total) (puntuacionObjeto ?p ?o))
	     )
  )
